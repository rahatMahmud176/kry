                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="tel" required maxlength="14" minlength="11" class="form-control" name="phoneNumber" id="">
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group  ">
                                ...
                                <select name="ourAccountNo" class="form-control select2"> 
                                    <option value="01707545044">01707545044 (Bkash Personal)</option> 
                                    <option value="1502390409001-city">1502390409001 (City Bank)</option> 
                                    <option value="255.110.2036-dbbl">255.110.2036 (DBBL)</option> 
                                    <option value="0016-0210031760-mtb">0016-0210031760 (MTB)</option>  
                                    <option value="1802101000002477-ucb">1802101000002477 (UCB)</option> 
                                    <option value="1531204640420001-brac">1531204640420001 (BRAC)</option>
                                    <option value="others">Others way</option>
                                </select>
                            </div>
                            <div class="form-group ">
                        ...
                        <div class="col-lg-12">
                            ...
                            <button type="submit" style="background: #2DD8CE" class="btn container-fluid text-light">Order Place</button>
                        </div>
