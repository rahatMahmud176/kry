...
@section('mainContent')
    <div class="container-fluid">
        ...
        <!-- end page title -->
        {{ Form::open(['route' => 'filter-pending-orders', 'method' => 'POST']) }}
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <label for="" class="d-none d-md-block">-</label> 
                    <a href="{{ route('pending-orders') }}" class="btn btn-outline-warning">Today Pending <i class="bx bx-loader bx-spin font-size-16 align-middle mr-2"></i></a> 
                </div>
            </div> 
        ...
        <div class="col-md-5 mx-auto">
            <h3 class="">
                ...
                @if (isset($requestDate))
                    {{ date('d-M-y', strtotime($requestDate)) }} (Pending Orders)
                @else
                   (Pending Orders)
                @endif
                </u>
