...
@section('mainContent')
    <div class="container-fluid">
        ...
        <!-- end page title -->
        {{ Form::open(['route' => 'filter-confirm-orders', 'method' => 'POST']) }}
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <label for="" class="d-none d-md-block">-</label> 
                    <a href="{{ route('confirm-orders') }}" class="btn btn-outline-success">Today Orders <i class="fas fa-check-circle"></i></a> 
                </div>
            </div> 
        ...
        <div class="col-md-5 mx-auto">
            <h3 class="">
                ...
                @if (isset($requestDate))
                    <span class="">{{ date('d-M-y', strtotime($requestDate)) }} (Confirmed Orders)</span>
                @else
