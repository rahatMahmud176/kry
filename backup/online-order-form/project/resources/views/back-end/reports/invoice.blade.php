            ...
            <div class="card">
                <div class="card-body">
                    <div class="invoice-title">
                        <h4 class="float-right font-size-16">KRYINT#00{{ $order->id }}</h4>
                        <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-sm-6 mt-3">
                            <address>
                               ...
                               <strong>Method:</strong> {{ $order->payMethod }}<br>
                                <strong>Transition ID:</strong> {{ $order->tnxId }}
                            </address>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    <td>01</td>
                                    <td>{{ $order->productName.' '.$order->variant }}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="border-0 text-right"> (-) {{ $advance = $order->payAmount }}.00/-</td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="border-0 text-right">
                                        <strong>Shipping</strong>  </td>
                                    <td class="border-0 text-right">(+){{ $shippingCharge = 120+($order->price-$order->payAmount)*0.01 }}.00/-</td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="border-0  text-right">
                                        <strong>Total</strong></td>
                                    <td class="border-0 text-right"><h4 class="m-0">{{ $order->price+$shippingCharge-$advance }}.00/-</h4></td>
                                </tr>
                                <tr>
