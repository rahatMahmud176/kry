...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{ Form::open(['route' => 'filter-today-delivery', 'method' => 'POST']) }}
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <tbody>
                            @foreach ($orders as $item)
                                <tr>
                                    ...
                                    <td class="{{ $item->order->zone=='outsideDhaka'?'text-danger':'text-success' }}">{{ $item->order->zone=='outsideDhaka'?'Courier':'HD' }}</td>
                                    <td>{{ $due = $item->order->price - $item->order->payAmount }}</td>
